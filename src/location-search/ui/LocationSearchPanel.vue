    ...
    <Panel :id="panelId" @closed="reset">
        <div class="m-auto w-full h-full max-w-screen-sm flex flex-col">
            <div class="flex items-center">
                <LocationSearchInput v-model="query" @update:modelValue="search($event)" />
                <GeolocationButton class="ml-1" @updated="handleSelect($event)" />
            </div>
...
import useLocationSearchPanel, { panelId } from "@/location-search/hooks/useLocationSearchPanel";
...
import GeolocationButton from "@/geolocation/ui/GeolocationButton.vue";
